...
<div class="card" style="width: 22rem;">
  ...
  <ul class="list-group list-group-flush">
      <hr>
    <li class="list-group-item"><strong>Need:</strong> ${card.need}</li>
    <li class="list-group-item"><strong>Quantity:</strong> ${card.quantity}</li>
  </ul>
  <div class="card-body">
    <a href="${card.websiteLink}" class="btnn btn-primary">Website link</a>
    <a href="mailto:contact@nonprofit.com" class="btnn btn-primary">Email us</a>
  </div>
</div>
<br>
`;
